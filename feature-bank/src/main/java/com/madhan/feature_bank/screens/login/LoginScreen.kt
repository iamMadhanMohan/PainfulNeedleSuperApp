package com.madhan.feature_bank.screens.login
...
fun LoginScreen(navController: NavController){
    ...
    var accountNumber by remember { mutableStateOf<String>("") }
    ...
    Column(
        ...
        BackTopBar("Login", navController)
        ...
        Text(
            text = "Enter the login you use on your bank's website",
            color = Color.Gray,
            fontSize = 16.sp,
        ...
        OutlinedTextField(
            ...
            onValueChange = { newValue -> accountNumber = newValue },
